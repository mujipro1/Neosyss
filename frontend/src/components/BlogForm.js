    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingBlogId) {
                ...
                const response = await axios.post('http://localhost:5000/api/edit-blog', formData, {
                    headers: {
                ...
                const response = await axios.post('http://localhost:5000/api/create-blog', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',  // Important for file uploads
                    },
                });
    ...
    const handleDelete = async () => {
        if (confirmDelete) {
            try {
                ...
                await axios.post('http://localhost:5000/api/delete-blog', { blogId: confirmDelete });
                fetchBlogs(); // Refresh blog list
