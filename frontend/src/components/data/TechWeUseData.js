const TechWeUseData = {
    ...
    "Artificial Intelligence": {
      ...
      tagline: "Neosyss leverages top AI and machine learning frameworks, including TensorFlow, PyTorch, OpenCV, and HuggingFace, ensuring reliability and precision in all our AI-driven solutions.",
      subOptions: {
        Tools: [
    ...
    "Block Chain": {
      heading: "Blockchain",
      tagline:"Neosyss leverages a comprehensive blockchain tech stack to provide security, transparency, and efficiency in all blockchain applications, enabling companies to securely manage digital assets and streamline workflows.",
      subOptions: {
        Tools: [
